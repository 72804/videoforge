...
SEMANTIC_PLANNER_INSTRUCTIONS = (
    ...
    "- Named real people: prefer archive/photograph/environment. "
    "Do not invent their appearance. Never generate a likeness.\n"
    "- Generic warehouse/barrel/inventory/transport reenactments are allowed as generic_only.\n"
    "- Prefer real archive, then stock video, then photographic AI stills.\n"
    "- Do not default to infographics, fake documents, schematic maps, or text cards "
    "just because narration mentions a number, date, legal result, or place.\n"
    "- Facts are spoken. Visuals provide atmosphere, place, people, objects, archive.\n"
    "- Alternate photographic subjects. Do not stack the same warehouse angle.\n"
...
def planner_input_text(
    ...
    return (
        ...
        "VISUAL_STYLE=restrained Canadian documentary photography/film; "
        "no fake historical photographs of named people; no generated infographics, "
        "fake documents, schematic maps, or data cards unless explicit_explainer=true; "
        "generic reenactment allowed for unsourced actions.\n\n"
        f"{catalog}"
